            ...
            else
            {
                if(doc)
                {
                  ...
                  const data = {
                      aqlevel:req.body.aqlevel,
                      favfish:req.body.favfish,
                      firstname:(req.body.firstname == ''?fuser.typeref.firstname:req.body.firstname),
                      lastname:(req.body.lastname == ''?fuser.typeref.lastname:req.body.lastname)
                }
                //console.log(fuser);
               RegModel.findByIdAndUpdate(fuser.typeref._id,data,{new:true},(err,doc)=> {
                   if(err)
                   {
                       console.log(err);
                   }
